...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (entry.getActivityClassName() != null && entry.getActivityClassName().contains("LinearUnitsConversionActivity")) {
    ...
    public static String getLocalizedTitle(Context context, HistoryEntry entry) {
        ...
        if (className.contains("TriangularLandActivityHeight")) {
            return context.getString(R.string.item_triangular) + " (" + context.getString(R.string.item_rectangular_height_based) + ")";
        } else if (className.contains("TriangularLandActivityArm")) {
            return context.getString(R.string.item_triangular) + " (" + context.getString(R.string.item_rectangular_arm_based) + ")";
        } else if (className.contains("RectangularLandActivity")) {
            return context.getString(R.string.item_quadrilateral) + " (" + context.getString(R.string.item_rectangular) + ")";
        } else if (className.contains("SquareLandActivity")) {
            return context.getString(R.string.item_quadrilateral) + " (" + context.getString(R.string.item_square) + ")";
        } else if (className.contains("ScaleneLandActivity")) {
            return context.getString(R.string.item_quadrilateral) + " (" + context.getString(R.string.item_scalene) + ")";
            ...
            return context.getString(R.string.header_side_calculation) + " (" + context.getString(R.string.item_triangular) + ")";
        } else if (className.contains("RectangleSideCalculatorActivity")) {
            return context.getString(R.string.header_side_calculation) + " (" + context.getString(R.string.item_quadrilateral) + " - " + context.getString(R.string.item_rectangular) + ")";
        } else if (className.contains("CircleSideCalculatorActivity")) {
            return context.getString(R.string.header_side_calculation) + " (" + context.getString(R.string.item_circular) + ")";
        }
    ...
    private static String getTwoCardString(Context context, String title, String serializedState) {
        ...
        if (parts.length >= 5) {
            ...
            if (unitResId == R.string.unit_foot) {
                firstFormatted = String.format("%.2f", firstVal)
                    + " "
                    + context.getString(R.string.unit_foot)
                    + " "
                ...
                secondFormatted = String.format("%.2f", secondVal)
                    + " "
                    + context.getString(R.string.unit_foot)
                    + " "
            ...
            return String.format(format1, title, isFeetStr) + " : " + firstFormatted + "\n" +
                   String.format(format2, title, isFeetStr) + " : " + secondFormatted;
        }
        return "";
    }
    ...
    public static String getLocalizedSubtitle(Context context, HistoryEntry entry) {
        ...
        try {
            if (className.contains("SquareLandActivity")) {
                return context.getString(R.string.card_length_title) + " : " + getSingleCardString(context, data);
            }
            
            if (className.contains("CircularLandActivity")) {
                return context.getString(R.string.card_radius_title) + " : " + getSingleCardString(context, data);
            }
            
            if (className.contains("RectangularLandActivity")) {
                String[] parts = data.split(";");
                if (parts.length >= 2) {
                    return context.getString(R.string.card_length_title) + " : " + getSingleCardString(context, parts[0]) + "\n" +
                           context.getString(R.string.card_width_title) + " : " + getSingleCardString(context, parts[1]);
                }
            }
            ...
            if (className.contains("TriangularLandActivityHeight")) {
                String[] parts = data.split(";");
                if (parts.length >= 2) {
                    return context.getString(R.string.card_base_title) + " : " + getSingleCardString(context, parts[0]) + "\n" +
                           context.getString(R.string.card_height_title) + " : " + getSingleCardString(context, parts[1]);
                }
            }
            ...
            if (className.contains("TriangularLandActivityArm")) {
                String[] parts = data.split(";");
                if (parts.length >= 3) {
                    return context.getString(R.string.first_arm_title) + " : " + getSingleCardString(context, parts[0]) + "\n" +
                           context.getString(R.string.second_arm_title) + " : " + getSingleCardString(context, parts[1]) + "\n" +
                           context.getString(R.string.third_arm_title) + " : " + getSingleCardString(context, parts[2]);
                }
            }
            ...
            if (className.contains("AreaUnitsConversionActivity")) {
                ...
                if (parts.length >= 2) {
                    ...
                    return context.getString(R.string.amount_of_land_title) + " : " + val + " " + context.getString(unitResId);
                }
            }
            ...
            if (className.contains("RectangleSideCalculatorActivity")) {
                ...
                if (parts.length >= 3) {
                    ...
                    return context.getString(R.string.amount_of_land_title) + ": " + areaStr + "\n" +
                           context.getString(R.string.first_arm_title) + ": " + getSingleCardString(context, parts[2]);
                }
            }
            ...
            if (className.contains("TriangleSideCalculatorActivity")) {
                ...
                if (parts.length >= 3) {
                    ...
                    String areaStr = String.format("%.2f", areaVal) + " " + context.getString(unitResId);
                    return context.getString(R.string.amount_of_land_title) + ": " + areaStr + "\n" +
                           context.getString(R.string.unknown_side_title) + ": " + getSingleCardString(context, parts[2]);
                }
            }
