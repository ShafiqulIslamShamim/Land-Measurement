...
public class SettingsActivity extends BaseActivity {
   ...
   * @param prefKey the prefKey
   * @param prefTitle the prefTitle
   * @param parentKey the parentKey
   * @param parentTitle the parentTitle
  ...
  public static class SettingsFragment extends PreferenceFragmentCompat
    ...
    /**
     * Setup preference screen listeners.
     *
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
      ...
      switch (key) {
        ...
        case KEY_PRIVACY:
          openUrl(
              ctx,
              "https://github.com/ShafiqulIslamShamim/Land-Measurement/blob/main/PrivacyPolicy.txt");
          return true;
